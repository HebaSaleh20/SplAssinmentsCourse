...
class DealerTest {
    ...
    @Test
    void timerCheck(){
        Timer t = new Timer(dealer.env);
        assertEquals(dealer.env.config.turnTimeoutMillis, t.currTime);
        assertEquals(dealer.env.config.turnTimeoutMillis, dealer.timer.currTime);
    }
}