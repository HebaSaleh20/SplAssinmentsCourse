...
class TableTest {
    ...
    @Test
     void removeCardTest()
    { fillSomeSlots();
        assertNotEquals(null,(Integer) slotToCard[1]);
        table.removeCard(1);
       assertEquals(null,(Integer) slotToCard[1]);
    }
    @Test
    void placeTokenTest()
    {   fillSomeSlots();
        assertEquals(0,(int) table.slotToPlayer[2][0]);
        assertNotEquals(1,(int) table.slotToPlayer[2][0]);
        table.placeToken(0,2);
        assertEquals(1,(int)table.slotToPlayer[2][0]);
        assertNotEquals(0,(int)table.slotToPlayer[2][0]);
    }
    @Test
    ...
    {   fillSomeSlots();
        ...
        assertEquals(1,(int)table.slotToPlayer[2][0]);
        assertNotEquals(0,(int)table.slotToPlayer[2][0]);
        table.removeToken(0,2);
        assertEquals(0,(int) table.slotToPlayer[2][0]);
        assertNotEquals(1,(int) table.slotToPlayer[2][0]);
    }
    @Test
    void tokensCountOfEachPlayerTest()
    {
        fillAllSlots();
        assertEquals(0,table.tokenscounter[0]);
        table.placeToken(0,1);
        assertEquals(1,table.tokenscounter[0]);
        table.placeToken(0,2);
        assertEquals(2,table.tokenscounter[0]);
        table.placeToken(0,3);
        assertEquals(3,table.tokenscounter[0]);
    }
